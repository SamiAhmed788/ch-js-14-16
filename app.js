...
// Question No 6
var mixArr = ["sami", 22, true," ",undefined,null];
// Question No 7
...
document.write("<br> Out: <br>" + out);
// Question No 15
var phoneManufacturers = ["Apple","Samsung","Motorola","infinix","Sony & techno"];
document.write("<hr><select><option>Apple </option><option>Samsung </option><option>Motorola </option> <option>infinix</option><option>Sony & techno</option></select>")
